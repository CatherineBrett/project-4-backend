...
with app.app_context():
    ...
    try:
        ...
        harborne_daytrippers = GroupModel(
            ...
            brief_desc="Days out in the Midlands",
            contact_name="George",
        ...
        italian_conversation = GroupModel(
            ...
            image="https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA",
        ...
        hwg_fitness = GroupCategoryModel(
            group_id=harborne_walking_group.id, category_id=5
        )
        hwg_fitness.save()

        hwg_outdoors = GroupCategoryModel(
            group_id=harborne_walking_group.id, category_id=6
        )
        hwg_outdoors.save()
        ...
        italian_social = GroupCategoryModel(
            group_id=italian_conversation.id, category_id=8
        )
        italian_social.save()

        gardeners_outdoors = GroupCategoryModel(
            group_id=golden_gardeners.id, category_id=6
        )
        gardeners_outdoors.save()

        drama_queens_culture = GroupCategoryModel(
            group_id=drama_queens.id, category_id=2
        )
        ...
        drama_queens_social = GroupCategoryModel(
            group_id=drama_queens.id, category_id=8
        )
